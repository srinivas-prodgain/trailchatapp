...
import { X, FileText, Calendar, HardDrive, Search, Check, FileSearch, Zap } from 'lucide-react';
import { useGetAllFilesMetaData } from '@/hooks/api/file';
import { useChatContext } from '@/contexts/chat-context';

interface FilesContextModalProps {
    isOpen: boolean;
    onClose: () => void;
}
...
export const FilesContextModal: React.FC<FilesContextModalProps> = ({
    isOpen,
    onClose
}) => {
                        ...
                        <div className="divide-y divide-gray-200">
                            {filteredFiles.map((file) => {
                                ...
                                return (
                                    <div
                                        key={file.file_id}
                                        className={`p-4 hover:bg-gray-50 transition-colors cursor-pointer ${isSelected ? 'bg-blue-50 border-r-4 border-blue-500' : ''
                                            }`}
